...
<div class="col-sm-12 col-lg-10 col-lg-offset-1">
  <section>
    ...
    <?php $cl++ ;?>
    <li <?php if ($json_data['features'][$n]['properties']['mag'] >= 6.5){?> style="color:RGB(224, 21, 36);" <?php } elseif($json_data['features'][$n]['properties']['mag'] >= 6){ ?> style="color:RGB(50, 250, 94);" <?php } elseif($json_data['features'][$n]['properties']['mag'] >= 5.5){ ?> style="color:RGB(50, 50, 194);" <?php }elseif($json_data['features'][$n]['properties']['mag'] >= 5){ ?> style="color:RGB(150, 80, 204);" <?php }elseif($json_data['features'][$n]['properties']['mag'] >= 4.5){ ?> style="color:RGB(250, 250, 0);" <?php } else{ ?> style="color:RGB(100, 100, 100);" <?php };?>>
